                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td class="form" colspan="2">
                                                    <form:input placeholder="Enter book title" cssClass="field" width="250px" path="title"/>
                                                </td>
                                            </tr>
                                                <%--description--%>
                                            <tr>
                                            <tr>
                                                <td class="font">
                                                    <form:label path="description">
                                                        <spring:message text="Book description:"/>
                                                    </form:label>
                                                </td>
                                            </tr>
                                            </tr>
                                            <tr>
                                                <td class="form" colspan="2">
                                                    <form:input placeholder="Enter book description: " cssClass="field" path="description"/>
                                                </td>
                                            </tr>
                                                        <%--author--%>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="form" colspan="2">
                                                            <form:input placeholder="Enter book author: " cssClass="field" path="author"/>
                                                        </td>
                                                    </tr>
                                                        <%--isbn--%>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="form" colspan="2">
                                                            <form:input placeholder="Enter book isbn: " cssClass="field" path="isbn"/>
                                                        </td>
                                                    </tr>
                                                        <%--printYear--%>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="form" colspan="2">
                                                            <form:input placeholder="Enter book printing  year: " cssClass="field" path="printYear"/>
                                                        </td>
                                                    </tr>
                                                <%--readAlready--%>
                                            <tr>
                                                <td class="font">
                                                    <form:label path="readAlready">
                                                        <spring:message text="Read this book before?"/>
                                                    </form:label>
                                                </td>
                    ...
                    <td>
                        <table class="form" width="100%">
                            <tr>
                                <td class="form">
                                    <form action="/">
                                        <input class="field" type="text" placeholder="Min 2 symbols or empty to reset" name="bookName" />
                            ...
                            <table class="tg" align="center" width="100%">
                                ...
                                <c:forEach items="${booksList}" var="book">
                                    <tr>
                                        ...
                                        <td align="center"><a href="<c:url value='/delete/${book.id}'/>"><img src="/resources/closecircle2.png"></a></td>
                                    </tr>
                                </c:forEach>
                            </table>
                        </c:if>
                        <c:if test="${empty booksList}"><center>List of books is empty.</center></c:if>
                    </td>
                </tr>
                <tr>
                    <td>
